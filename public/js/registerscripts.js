$(document).ready(function() {
    ...
    $('#form-2').submit(function() {
        ...
        // verificar que se aceptaron términos y condiciones
        if(!$('#acceptTerms').is(':checked')){
            $('#errorMessage4').html('Debe acpetar términos condiciones');
            return false;
        }
...
function validatePart1() {
    ...
    if (password === '') {
        showErrorMessage1('La contraseña no puede estar vacía');
        return false;
